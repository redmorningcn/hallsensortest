...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.bt_speedadd.setGeometry(QtCore.QRect(30, 340, 160, 80))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(20)
        ...
        self.bt_speedsub.setGeometry(QtCore.QRect(240, 340, 160, 80))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(20)
        ...
        self.bt_shutdown.setGeometry(QtCore.QRect(450, 340, 160, 80))
        self.bt_shutdown.setObjectName("bt_shutdown")
        self.ln_speed = QtWidgets.QLCDNumber(self.centralwidget)
        self.ln_speed.setGeometry(QtCore.QRect(70, 120, 211, 131))
        ...
        self.label.setGeometry(QtCore.QRect(180, 30, 411, 31))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(20)
        font.setBold(True)
        ...
        self.label_2.setGeometry(QtCore.QRect(230, 430, 311, 31))
        font = QtGui.QFont()
        font.setFamily("Arial")
        ...
        self.label_3.setGeometry(QtCore.QRect(20, 140, 31, 121))
        font = QtGui.QFont()
        ...
        self.line.setGeometry(QtCore.QRect(0, 80, 700, 16))
        ...
        self.line_2.setGeometry(QtCore.QRect(-10, 310, 700, 16))
        ...
        self.ln_speed_1250.setGeometry(QtCore.QRect(510, 110, 121, 71))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Minimum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(1)
        ...
        self.ln_speed_1050.setGeometry(QtCore.QRect(510, 220, 121, 71))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Minimum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(1)
        ...
        self.label_4.setGeometry(QtCore.QRect(410, 130, 91, 51))
        font = QtGui.QFont()
        font.setFamily("Arial")
        ...
        self.label_5.setGeometry(QtCore.QRect(410, 220, 91, 61))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(16)
        ...
        self.label_6.setGeometry(QtCore.QRect(350, 140, 31, 121))
        font = QtGui.QFont()
        font.setFamily("04b_21")
        font.setPointSize(20)
        ...
        self.line_3.setGeometry(QtCore.QRect(310, 90, 20, 231))
        self.line_3.setFrameShadow(QtWidgets.QFrame.Raised)
        self.line_3.setLineWidth(2)
        self.line_3.setFrameShape(QtWidgets.QFrame.VLine)
        self.line_3.setObjectName("line_3")
        self.line_4 = QtWidgets.QFrame(self.centralwidget)
        self.line_4.setGeometry(QtCore.QRect(400, 190, 291, 30))
        self.line_4.setFrameShape(QtWidgets.QFrame.HLine)
        self.line_4.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.line_4.setObjectName("line_4")
        self.line_5 = QtWidgets.QFrame(self.centralwidget)
        self.line_5.setGeometry(QtCore.QRect(390, 90, 20, 231))
