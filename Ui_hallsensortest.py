...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.bt_speedadd.setGeometry(QtCore.QRect(10, 320, 145, 80))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(20)
        ...
        self.bt_speedsub.setGeometry(QtCore.QRect(180, 320, 145, 80))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(20)
        ...
        self.bt_shutdown.setGeometry(QtCore.QRect(350, 320, 145, 80))
        self.bt_shutdown.setObjectName("bt_shutdown")
        self.ln_speed = QtWidgets.QLCDNumber(self.centralwidget)
        self.ln_speed.setGeometry(QtCore.QRect(70, 100, 211, 121))
        ...
        self.label_2.setGeometry(QtCore.QRect(230, 420, 311, 20))
        font = QtGui.QFont()
        font.setFamily("Arial")
        ...
        self.label_3.setGeometry(QtCore.QRect(20, 110, 31, 121))
        font = QtGui.QFont()
        ...
        self.line_2.setGeometry(QtCore.QRect(-10, 290, 700, 16))
        ...
        self.ln_speed_1250.setGeometry(QtCore.QRect(510, 90, 121, 71))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Minimum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(1)
        ...
        self.ln_speed_1050.setGeometry(QtCore.QRect(510, 200, 121, 71))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Minimum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(1)
        ...
        self.label_4.setGeometry(QtCore.QRect(410, 110, 91, 51))
        font = QtGui.QFont()
        font.setFamily("Arial")
        ...
        self.label_5.setGeometry(QtCore.QRect(410, 200, 91, 61))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(16)
        ...
        self.label_6.setGeometry(QtCore.QRect(350, 120, 31, 121))
        font = QtGui.QFont()
        font.setFamily("04b_21")
        font.setPointSize(20)
        ...
        self.line_3.setGeometry(QtCore.QRect(310, 70, 20, 231))
        self.line_3.setFrameShadow(QtWidgets.QFrame.Raised)
        self.line_3.setLineWidth(2)
        self.line_3.setFrameShape(QtWidgets.QFrame.VLine)
        self.line_3.setObjectName("line_3")
        self.line_4 = QtWidgets.QFrame(self.centralwidget)
        self.line_4.setGeometry(QtCore.QRect(400, 170, 291, 30))
        self.line_4.setFrameShape(QtWidgets.QFrame.HLine)
        self.line_4.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.line_4.setObjectName("line_4")
        self.line_5 = QtWidgets.QFrame(self.centralwidget)
        self.line_5.setGeometry(QtCore.QRect(388, 70, 10, 231))
        ...
        self.bt_shutdown_2.setGeometry(QtCore.QRect(530, 320, 145, 80))
        self.bt_shutdown_2.setObjectName("bt_shutdown_2")
        self.bt_dir = QtWidgets.QPushButton(self.centralwidget)
        self.bt_dir.setGeometry(QtCore.QRect(70, 230, 211, 61))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(20)
