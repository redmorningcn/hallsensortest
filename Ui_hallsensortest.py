...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.bt_speedadd.setGeometry(QtCore.QRect(30, 280, 160, 120))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(20)
        ...
        self.bt_speedsub.setGeometry(QtCore.QRect(240, 280, 160, 120))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(20)
        ...
        self.bt_shutdown.setGeometry(QtCore.QRect(450, 280, 160, 120))
        self.bt_shutdown.setObjectName("bt_shutdown")
        self.ln_speed = QtWidgets.QLCDNumber(self.centralwidget)
        self.ln_speed.setGeometry(QtCore.QRect(153, 86, 461, 150))
        ...
        self.label_2.setGeometry(QtCore.QRect(230, 418, 311, 31))
        font = QtGui.QFont()
        font.setFamily("Arial")
        ...
        self.label_3.setGeometry(QtCore.QRect(60, 100, 31, 121))
        font = QtGui.QFont()
        ...
        self.line.setGeometry(QtCore.QRect(0, 60, 700, 16))
        self.line.setLineWidth(1.5)
        self.line.setFrameShape(QtWidgets.QFrame.HLine)
        self.line.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.line.setObjectName("line")
        self.line_2 = QtWidgets.QFrame(self.centralwidget)
        self.line_2.setGeometry(QtCore.QRect(0, 250, 700, 16))
        self.line_2.setLineWidth(1.5)
